...
GO
SELECT * FROM HOADON WHERE DAY(TGLAP)=2022
go
SELECT * FROM HDCTMON 
select * from CTMON

SELECT DISTINCT TENMON as TEN, SOLUONG, GIAMON AS DONGIA,GIAMON * SOLUONG AS THANHTIEN FROM MON, HDMON WHERE MON.IDMON IN (SELECT IDMON FROM HDMON WHERE IDHD = 'HD0000001')
Union 
SELECT DISTINCT TENCOMBO as TEN, SOLUONG,GIACOMBO AS DONGIA, GIACOMBO * SOLUONG AS THANHTIEN FROM COMBO, HDCOMBO WHERE COMBO.IDCOMBO IN (SELECT IDCOMBO FROM HDCOMBO WHERE IDHD = 'HD0000001')
Union 
SELECT DISTINCT TENCTM as TEN, SOLUONG, TIENTHEM AS DONGIA,TIENTHEM * SOLUONG AS THANHTIEN FROM CTMON, HDCTMON WHERE CTMON.IDCTMON IN (SELECT DISTINCT IDCTMON FROM HDCTMON WHERE IDHD = 'HD0000001') 